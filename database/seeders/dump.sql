...
INSERT INTO public.z_modules (id, name, title, tip, ismenu, icon, url, author, memo, _lft, _rgt, parent_id, created_at, updated_at) VALUES (61, 'xapp1s1activate', '活动管理', NULL, 'A', 'festival', 'xapp1s1activate', 'vue-auth', NULL, 44, 45, 54, '2022-08-10 12:55:59', '2022-08-10 12:56:09');
...
INSERT INTO public.z_modules (id, name, title, tip, ismenu, icon, url, author, memo, _lft, _rgt, parent_id, created_at, updated_at) VALUES (49, 'xapp1s1', '朋棚', NULL, 'A', 'groups', NULL, 'vue-auth', NULL, 32, 59, 1, '2022-08-03 10:55:26', '2022-08-10 12:56:09');
